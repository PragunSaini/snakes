CXX := g++
CXX_DFLAGS := -std=c++11 -DNDEBUG -Ofast -march=native -mavx -mfma -msse2 -fopenmp -ffast-math -fno-math-errno
CXX_FLAGS := -std=c++11 -ggdb -Ofast -march=native -mavx -mfma -msse2 -fopenmp -ffast-math -fno-math-errno
