...
//         if ((currGen >= 500 && currGen % 100 == 0 && globalBest[0].score == 97)) {
//             std::cout << "Continue ?";
//             char ch;
//             std::cin >> ch;
//             if (ch != 'Y' && ch != 'y')
...
//     for (int i = 0; i < 150; i++) {
//         std::cout << globalBest[i].fitness << "| " << globalBest[i].seed << "\n";
